...
export function buildAccessApprovedUserMessage(user = {}) {
  ...
  return [
    ...
    "",
    "На платформе доступны рабочие инструменты и сохранённые результаты. Откройте её по кнопке под этим сообщением. Позже вход всегда будет доступен как «Платформа AI-BOSS» в меню бота."
  ].join("\n");
}
