...
export function buildAccessApprovedUserMessage(user = {}) {
  ...
  return [
    greeting,
    "",
    "Я AI-BOSS — управляющий помощник платформы для сборки бизнеса как системы.",
    "",
    "Здесь, в чате, мы общаемся: можно писать текстом, отправлять голосовые сообщения, файлы и ссылки. Основная работа проходит в веб-кабинете: там собираются архитектура, диагностика, инструменты и результаты компании.",
    "",
    "Создайте кабинет компании. После входа AI-BOSS поможет выбрать первый маршрут и будет сопровождать работу на каждом этапе."
  ].join("\n");
}
