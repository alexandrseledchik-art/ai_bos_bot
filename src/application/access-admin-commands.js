...
export function buildAccessApprovedUserMessage(user = {}) {
  ...
  return [
    ...
    "",
    "На платформе доступны рабочие инструменты и сохранённые результаты. Откройте её по кнопке под этим сообщением. Позже открыть платформу можно командой /platform в меню бота."
  ].join("\n");
}
