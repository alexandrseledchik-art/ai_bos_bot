...
function buildVagueSurfaceResponse(response, context) {
  ...
  if (isOpeningMessageContext(context) && language === "ru") {
    ...
    return joinParagraphs([
      `${greeting} Я помогаю найти главное ограничение бизнеса, отделить симптом от причины и понять, что делать первым. По ситуации могу быть диагностом, архитектором системы, навигатором по инструментам или партнёром по следующему шагу.`,
