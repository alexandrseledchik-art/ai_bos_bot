...
export const MINI_APP_CABINET_SCREENS = {
  dashboard: {
    ...
    purpose: "Показать рабочее пространство кейса: профиль компании, диагностику, архитектуру бизнеса, матрицу зрелости и инструменты."
  },
  onboarding: {
    screenId: "onboarding",
  ...
  ceo: {
    screenId: "ceo",
    route: "/mini-app/ceo",
    label: "Открыть управленческую повестку",
    title: "Управленческая повестка",
  ...
  assembly: {
    ...
    label: "Открыть архитектуру бизнеса",
