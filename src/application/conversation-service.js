...
function buildPlatformWelcomeMessage(userMeta = {}, { returning = false } = {}) {
  ...
  return [
    ...
    "",
    "На платформе доступны рабочие инструменты и сохранённые результаты. Перейти туда можно по кнопке под этим сообщением. Позже открыть платформу можно командой /platform в меню бота.",
    "",
    startLine
  ].join("\n");
}
