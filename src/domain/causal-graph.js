...
export const CAUSAL_GRAPH_NODES = [
  ...
  },
  {
    ...
    contradictionPatterns: [],
    relatedQuestions: [
      "По последним 20 обращениям что видно в фактах: продавцы получают уже отфильтрованный поток или сначала руками разбирают, кто вообще целевой и кому отвечать первым?"
    ]
  },
  {
    ...
    contradictionPatterns: [],
    relatedQuestions: [
      "По последним 20 лидам что видно в фактах: продавцы берут их в работу сразу или сначала руками сортируют, квалифицируют и приоритизируют вход?"
    ]
  },
  {
  ...
  },
  {
    ...
    contradictionPatterns: [],
    relatedQuestions: [
      "Если правила у всех одинаковые, покажи факт: где эти критерии уже жёстко закреплены в рекламе, квалификации и передаче дальше, а где всё ещё держится на ручном решении команды?"
    ]
  },
  {
    ...
    contradictionPatterns: [],
    relatedQuestions: [
      "Если конверсия у всех похожая, дай один факт: вы одинаково применяете уже точный фильтр, или одинаково тратите время на слишком широкий и смешанный сегмент?"
    ]
  },
  {
    ...
    contradictionPatterns: [],
    relatedQuestions: [
      "Если подняться выше операционки, мне нужен факт: где у вас уже жёстко закреплены критерии ICP — в рекламе, квалификации, приоритете и handoff, а где команда до сих пор решает это вручную?"
    ]
  },
  {
  ...
  },
  {
    ...
    contradictionPatterns: [],
    relatedQuestions: [
      "По последним 20 лидам что видно в фактах: до команды доходит уже качественный и отобранный поток или вместе с ним приходит шум, который приходится разбирать вручную?"
    ]
  },
  {
