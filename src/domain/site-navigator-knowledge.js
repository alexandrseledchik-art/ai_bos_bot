...
export const SITE_NAVIGATOR_SOURCES = Object.freeze([
  ...
  },
  {
    id: "ai-boss",
    group: "ai_boss",
    title: "AI‑BOSS — цифровой управленческий партнёр",
    ...
    summary: "AI‑BOSS — цифровой управленческий партнёр собственника. Он соединяет живой диалог, диагностику, инструменты и память компании, чтобы собрать картину бизнеса, найти главное ограничение и выбрать первый шаг."
  },
  {
    id: "consulting",
    group: "consulting",
