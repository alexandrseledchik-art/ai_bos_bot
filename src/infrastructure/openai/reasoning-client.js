...
function buildToolFirstDecision(context) {
  ...
  const responseText = isSpecific
    ? `Понял, ты пришёл за конкретным инструментом, а не за разбором с нуля. ${requestedTool.name} — это ${requestedTool.explanation}.\n\nНа этом этапе я подсвечу, зачем он нужен и как применить его под реальный кейс. Сам рабочий артефакт лучше отдавать отдельным каналом: ссылкой на готовый инструмент, мини-приложением или генерацией в чате, когда мы выберем формат.\n\nСкажи: для какого процесса, решения или зоны он сейчас нужен?`
    : "Понял, тебе сейчас нужен инструмент, а не общие советы. Я подсвечу инструмент под задачу и объясню, зачем он нужен, но не буду сразу разворачивать его в большой артефакт.\n\nДальше сам инструмент можно будет отдавать ссылкой, в мини-приложении или прямо в чате, когда мы выберем формат. В какой зоне нужен инструмент: продажи, роли и ответственность, финансы, процессы или подготовка бизнеса к продаже?";
