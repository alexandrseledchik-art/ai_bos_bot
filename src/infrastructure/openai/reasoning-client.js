...
function buildMetaRoleDecision(context) {
  ...
  const responseText = isInternalConsultingCase
    ...
    : [
        "Я AI-BOSS — ваш цифровой управленческий партнёр. Я работаю как CEO-контур рядом с собственником: собираю факты, помогаю отделить симптом от причины, выбрать рабочую гипотезу и довести её до следующего действия.",
