...
function renderMaturity() {
  ...
  return `
    <section class="hero compact">
      ...
      <p>Это быстрый срез по оцененным областям: где уже есть опора, где виден риск и где система может проседать. Средняя оценка даёт общий фон зрелости, а детали по областям помогают понять, что проверить дальше. Главное ограничение выбираем отдельно: по текущему запросу, сигналам из диалога и связям между областями.</p>
      <div class="status-row">
