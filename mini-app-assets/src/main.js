      ...
      <ul class="plain-list">
        <li>
          ...
          <span>${escapeHtml(strong.length
            ...
            : "Явные сильные стороны 4-5/5 пока не выделены. Значит, первые шаги должны быть небольшими и проверочными."
          )}</span>
        </li>
        <li>
          <strong>Слабые области</strong>
          <span>${escapeHtml(weak.length
            ? `${formatMaturityAreas(weak)}. Это слабые места, но не каждое слабое место автоматически является главным ограничением.`
