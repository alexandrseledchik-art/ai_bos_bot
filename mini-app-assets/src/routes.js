export const ROUTES = [
  {
    ...
    description: "Стартовая панель: профиль компании, архитектура бизнеса, диагностика, матрица зрелости, инструменты и разбор с экспертом."
  },
  {
  ...
  {
    path: "/mini-app/assembly",
    title: "Архитектура бизнеса",
    eyebrow: "Система",
    description: "Последовательная сборка бизнеса по 11 слоям через факты, документы, инструменты и решения."
  },
  {
    path: "/mini-app/tools",
    title: "Инструменты",
